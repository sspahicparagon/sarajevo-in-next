...
const Privacy: NextPage = () => {
  return (
    <Flex marginInline={
      ...
      direction={'column'}>
      <Heading as={'h1'}
        fontSize={'4xl'}>Privacy Policy</Heading>
      ...
      <Heading as={'h3'}
        fontSize={'2xl'}>Interpretation</Heading>
      ...
      <Heading as={'h3'}
        fontSize={'2xl'}>Definitions</Heading>
      ...
      <UnorderedList>
        ...
        <ListItem>
          <Text>
            ...
            (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SarajevoIN.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>Cookies</strong>
            are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>Country</strong>
            refers to:  Bosnia &amp; Herzegovina</Text>
        </ListItem>
        <ListItem>
          <Text>
        ...
        <ListItem>
          <Text>
            ...
            is any information that relates to an identified or identifiable individual.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>Service</strong>
            refers to the Website.</Text>
        </ListItem>
        <ListItem>
          <Text>
        ...
        <ListItem>
          <Text>
            ...
            refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>Website</strong>
            refers to SarajevoIN, accessible from
            <a href="https://www.sarajevoin.ba" rel="external nofollow noopener" target="_blank">https://www.sarajevoin.ba</a>
          </Text>
        </ListItem>
        <ListItem>
          <Text>
      ...
      <Heading as={'h2'}
        fontSize={'3xl'}>Collecting and Using Your Personal Data</Heading>
      <Heading as={'h3'}
        fontSize={'2xl'}>Types of Data Collected</Heading>
      <Heading as={'h4'}
        fontSize={'larger'}>Personal Data</Heading>
      ...
      <Heading as={'h4'}
        fontSize={'larger'}>Tracking Technologies and Cookies</Heading>
      <Text>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</Text>
      <UnorderedList>
        <ListItem>
      ...
      <Text>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the
        <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" target="_blank">Privacy Policies website</a>
        article.</Text>
      ...
      <Text>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</Text>
      <Heading as={'h3'}
        fontSize={'2xl'}>Use of Your Personal Data</Heading>
      <Text>The Company may use Personal Data for the following purposes:</Text>
      <UnorderedList>
        <ListItem>
          <Text>
            <strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>To manage Your Account:</strong>
            to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>For the performance of a contract:</strong>
            the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.</Text>
        </ListItem>
        <ListItem>
          <Text>
        ...
        <ListItem>
          <Text>
            ...
            with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</Text>
        </ListItem>
        <ListItem>
          <Text>
            <strong>To manage Your requests:</strong>
            To attend and manage Your requests to Us.</Text>
        </ListItem>
        <ListItem>
          <Text>
        ...
        <ListItem>
          <Text>
            <strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</Text>
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList>
        <ListItem>
          ...
          We may share Your personal information with Service Providers to monitor and analyze the use of our Service,  to contact You.</ListItem>
        <ListItem>
          <strong>For business transfers:</strong>
          We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</ListItem>
        <ListItem>
          <strong>With Affiliates:</strong>
          We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</ListItem>
        <ListItem>
          <strong>With business partners:</strong>
          We may share Your information with Our business partners to offer You certain products, services or promotions.</ListItem>
        <ListItem>
          <strong>With other users:</strong>
          when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</ListItem>
        <ListItem>
          <strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</ListItem>
      </UnorderedList>
      <Heading as={'h3'}
        fontSize={'2xl'}>Retention of Your Personal Data</Heading>
      ...
      <Heading as={'h3'}
        fontSize={'2xl'}>Delete Your Personal Data</Heading>
      <Text>You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.</Text>
      <Text>Our Service may give You the ability to delete certain information about You from within the Service.</Text>
      ...
      <Text>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</Text>
      <Heading as={'h3'}
        fontSize={'2xl'}>Disclosure of Your Personal Data</Heading>
      <Heading as={'h4'}
        fontSize={'larger'}>Business Transactions</Heading>
      ...
      <Heading as={'h4'}
        fontSize={'larger'}>Law enforcement</Heading>
      ...
      <Heading as={'h4'}
        fontSize={'larger'}>Other legal requirements</Heading>
      ...
      <Heading as={'h3'}
        fontSize={'2xl'}>Contact Us</Heading>
      <Text>If you have any questions about this Privacy Policy, You can contact us:</Text>
      <UnorderedList>
        <ListItem>
          <Link href="mailto:info@sarajevoin.ba">
            <Text>By email: info@sarajevoin.ba</Text>
          </Link>
        </ListItem>
        <ListItem>
          <Text>By visiting this page on our website:
            <ChakraNextLink href="/privacy" rel="external nofollow noopener" target="_blank">https://www.sarajevoin.ba/privacy</ChakraNextLink>
          </Text>
        </ListItem>
      </UnorderedList>
    </Flex>
